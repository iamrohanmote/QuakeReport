...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray arrayJSON = rootJSON.getJSONArray("features");
            for (int i = 0; i < arrayJSON.length(); i++) {
                JSONObject featuresObject = arrayJSON.getJSONObject(i);
                ...
                Earthquake getEarthQuake = new Earthquake(mag,place,time);
                earthquakes.add(getEarthQuake);
            }
